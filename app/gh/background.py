...
class BackgroundTask:
    ...
    async def _check(self):
        for file in await util.get_dir_files(self.cache_dir, sort=util.FileSort.CTIME):
        ...
        if cache_size > self.max_cache:
            for file in await util.get_dir_files(
                self.cache_dir, sort=util.FileSort.CTIME
            ):
